...
extern int network_device_read(unsigned char *buffer, unsigned int buffer_size);
extern int network_device_send(const unsigned char *buffer, unsigned int len,
